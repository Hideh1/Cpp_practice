...
{
    test(Mystring("abc"));
    test("abc") ;  // 암시적변환으로 Mystring으로 넣어준다    그래서 위랑 같음
    test(65) ; // 분명 오류인데 암시적 변환으로 인해 Mystring으로 넣는다.
    //근데 int를 explicit하니깐 그냥 char로 바꿔서 들어가네 ㅋㅋㅋㅋㅋㅋㅋㅋ
/*
    explicit는 복사생성자도 막는다.
    그래서 
